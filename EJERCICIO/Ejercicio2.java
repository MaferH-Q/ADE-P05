...
public class Ejercicio2 {
    ...
    // Este método invierte el orden de una lista genérica y devuelve una nueva lista con los elementos invertidos
    public static <T> List<T> invertirLista(List<T> listaOriginal) {
        ...
        for (int i = listaOriginal.size() - 1; i >= 0; i--) {
            listaInvertida.add(listaOriginal.get(i)); // Vamos añadiendo cada elemento desde atrás hacia adelante
        }
    ...
    public static void main(String[] args) {
        // Creamos una lista genérica con valores de tipo String
